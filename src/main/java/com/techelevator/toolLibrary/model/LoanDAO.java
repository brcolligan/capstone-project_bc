...
public class LoanDAO {
	...
	public Tool getToolByInventoryId(int toolInventoryId) {
		...
		if (results.next()) {
			 ...
			 * newTool.setToolCategoryName(results.getString(
			 * "tool_category_name"));
			 ...
			 * newTool.setToolName(results.getString("name")); foundTool = new
			 * Tool (toolName, toolDescription, toolLoanPeriod, toolId,
			 * toolCategoryId, toolCategoryName, toolInventoryId);
			 * 
			 * 
			*/
